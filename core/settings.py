...
SECRET_KEY = 'django-insecure-cz7q9e6neoiq=3(rob^8x_01dhn(^x&uk1q2$!a#7)$1=0r3h4'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # O Django tentará usar o 'psycopg' v3 automaticamente
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Adicione este caminho aqui
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
